...
void CVertexBuffer::initBuffer()
{
    ...
    {
        glVertexAttribPointer(i, 3, GL_FLOAT, GL_FALSE, sizeof(SVertex), (void*)(i * sizeof(glm::vec3)));
    ...
    for (atUint32 i = 0; i < 2; i++)
    {
        glVertexAttribPointer(i + 2, 1, GL_UNSIGNED_INT, GL_FALSE, sizeof(SVertex), (void*)(i * sizeof(atUint32) + 0x18));
    ...
    {
        glVertexAttribPointer(i + 4, 2, GL_FLOAT, GL_FALSE, sizeof(SVertex), (void*)(i * sizeof(glm::vec2) + 0x20));
